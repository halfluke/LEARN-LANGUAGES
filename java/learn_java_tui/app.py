...
from learn_java_tui.chapters import Chapter, Exercise, load_chapters
from learn_java_tui.editor import launch_editor
from learn_java_tui.executor import ExecutionResult, execute_code
from learn_java_tui.progress import ProgressStore
from learn_java_tui.validator import Validator, ValidationResult
...
class LearnJavaApp(App[None]):
    ...
    def on_mount(self) -> None:
        ...
        try:
            ...
            return
        self.progress.load()
        self._build_dir = Path(tempfile.mkdtemp(prefix="learn-java-tui-"))
        self.refresh_body()
...
Code: [yellow]r[/yellow] compile and run (javac + java) · [yellow]e[/yellow] external editor · [yellow]b[/yellow] back

...
Uses the same pipeline as learn_c_tui.executor: cc/gcc, -std=c11, optional -lm.
...
Env:
  LEARN_C_CHECK_WORK  override build dir (default: <repo>/.check-c-work)
"""
...
DEFAULT_CHECK_WORK = ROOT / ".check-c-work"

sys.path.insert(0, str(ROOT))

from learn_c_tui.executor import execute_code  # noqa: E402
...
def main() -> int:
    ...
    work_env = os.environ.get("LEARN_C_CHECK_WORK", "").strip()

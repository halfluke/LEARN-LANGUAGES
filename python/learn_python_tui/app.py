...
from learn_python_tui.chapters import Chapter, Exercise, load_chapters
from learn_python_tui.editor import launch_editor
from learn_python_tui.executor import ExecutionResult, execute_code
from learn_python_tui.progress import ProgressStore
from learn_python_tui.validator import Validator, ValidationResult
...
class LearnPythonApp(App[None]):
    ...
    def on_mount(self) -> None:
        ...
        try:
            ...
            return
        self.progress.load()
        self._build_dir = Path(tempfile.mkdtemp(prefix="learn-python-tui-"))
        self.refresh_body()
...
Code: [yellow]r[/yellow] run (python3) · [yellow]e[/yellow] external editor · [yellow]b[/yellow] back

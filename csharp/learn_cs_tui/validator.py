"""Compare dotnet stdout to expected_output (trimmed), exit code 0."""

from __future__ import annotations

from dataclasses import dataclass

from learn_cs_tui.chapters import Exercise
from learn_cs_tui.executor import ExecutionResult
...
class Validator:
    ...
    def validate(
        ...
        if exec_res.exit_code != 0:
            msg = "Build or run did not complete successfully.\n"
